...
public class HomeController {
	...
	public String helloworld(Locale locale, Model model) {
		logger.info("helloworld! The client locale is {}.", locale);
       ...
       public String querystring2(Model model, @RequestParam(value="name", defaultValue="") String name, 
