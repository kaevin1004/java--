...
<body>  
    ...
    <a href="spring/querystring2?name=천사&price=1004" target="_blank">/spring/querystring2?name=test&phone=1244</a> <br />
    <a href="spring/querypath/test" target="_blank">/spring/querypath/test</a> <br />
    <a href="spring/querypath/test/1244" target="_blank">/spring/querypath/test/1244</a> <br />
    <hr />
