...
public class FragmentTab1 extends Fragment {
    ...
    private List<String> inflatedview = null;
    
    private View infatedview = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        infatedview =  inflater.inflate(R.layout.fragment_tab1, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mListView = infatedview.findViewById(R.id.list_view);
        mData = makeData();
        ...
        btn_add = infatedview.findViewById(R.id.btn_add);
        edit_input = infatedview.findViewById(R.id.edit_input);
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mData.add(edit_input.getText().toString());
