...
public class jv10_01_ArrayList {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("리스트를 for문으로 출력 : ");
        ...
        System.out.print("리스트를 for-each문으로 출력 : ");
         ...
         */ 
        pos = list.indexOf("APPLE");// 값으로 방번호 찾기
        System.out.println("S: 검색 방번호 >>"+ pos);
        ...
        /* 검색2. APPLE 이 몇개 있나요? (for문으로 돌면서 찾아야 한다.)
         */
        int count = 0;
        for(int i=0; i<=list.size()-1; i=i+1){
        ...
        list.removeAll(list);
        System.out.println("list의 모든 값을 삭제하시오 >> " + list);
